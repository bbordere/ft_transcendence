...
import { faGear, faRightFromBracket, faPen, faLock, faUserGroup, faUserPlus, faCirclePlus, faCheck, faXmark, faGamepad} from '@fortawesome/free-solid-svg-icons'
...
library.add(faGear, faRightFromBracket, faPen, faLock, faUserGroup, faUserPlus, faCirclePlus, faCheck, faXmark, faGamepad);
